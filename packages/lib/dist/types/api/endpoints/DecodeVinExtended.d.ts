 ...
 */
declare function DecodeVinExtended(vin: string): Promise<NhtsaResponse<DecodeVinExtendedResults>>;
declare function DecodeVinExtended(vin: string, params: {
    modelYear: string | number;
}): Promise<NhtsaResponse<DecodeVinExtendedResults>>;
declare function DecodeVinExtended(vin: string, params: {
    modelYear: string | number;
}, doFetch: true): Promise<NhtsaResponse<DecodeVinExtendedResults>>;
declare function DecodeVinExtended(vin: string, doFetch: true, _dummy?: undefined): Promise<NhtsaResponse<DecodeVinExtendedResults>>;
declare function DecodeVinExtended(vin: string, params: {
    modelYear: string | number;
}, doFetch: false): Promise<string>;
declare function DecodeVinExtended(vin: string, doFetch: false, _dummy?: undefined): Promise<string>;
