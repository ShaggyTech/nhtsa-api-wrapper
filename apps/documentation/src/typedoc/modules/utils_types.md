...
[utils/types.ts:18](https://github.com/ShaggyTech/nhtsa-api-wrapper/blob/1e31d45/packages/lib/src/utils/types.ts#L18)
...
[utils/types.ts:26](https://github.com/ShaggyTech/nhtsa-api-wrapper/blob/1e31d45/packages/lib/src/utils/types.ts#L26)
