...
[@shaggytools/nhtsa-api-wrapper](../../modules.md) / api/endpoints/DecodeVinValuesBatch
...
`Promise`\<[`NhtsaResponse`](../types.md#nhtsaresponset)\<[`DecodeVinValuesBatchResults`](DecodeVinValuesBatch.md#decodevinvaluesbatchresults)\>\>
