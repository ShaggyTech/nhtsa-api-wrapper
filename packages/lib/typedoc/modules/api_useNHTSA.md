[@shaggytools/nhtsa-api-wrapper](../README.md) / [Exports](../modules.md) / api/useNHTSA
...
| `params?` | [`QueryStringParams`](utils_createQueryString.md#querystringparams) |
| `path?` | `string` |
| `saveUrl?` | `boolean` |

#### Defined in

[api/useNHTSA.ts:10](https://github.com/ShaggyTech/nhtsa-api-wrapper/blob/e851323/packages/lib/src/api/useNHTSA.ts#L10)
...
[api/useNHTSA.ts:44](https://github.com/ShaggyTech/nhtsa-api-wrapper/blob/e851323/packages/lib/src/api/useNHTSA.ts#L44)
