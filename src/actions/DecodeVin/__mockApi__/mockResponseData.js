const data = {
  ...
  SearchCriteria: 'VIN:WVWKG61J34D132375',
  Results: [
    {
      Value: 'axios is being mocked from actions/DecodeVin/__mocks__/axios',
      ValueId: 'data from __mocks__/mockResponse.js',
